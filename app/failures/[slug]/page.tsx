          ...
          <section className="mb-10">
            ...
            <ol className="space-y-4">
              {[
                ...
                { n: '04', title: 'Send to support@runwayml.com', body: 'Keep the tone factual and professional. State the credit cost and request a full refund. Attach a PDF audit report if available.' },
              ].map((step) => (
