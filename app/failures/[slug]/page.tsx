          ...
          <section className="mb-10">
            ...
            <ol className="space-y-4">
              {[
                ...
                { n: '04', title: 'Submit via Runway support chat or Discord', body: "Runway has no email support — open the in-app chat widget (bottom-right of app.runwayml.com) or post in the Runway Discord #support channel. Paste your refund message and attach the PDF audit report. Discord is checked during business hours; refund DMs are routed from there." },
              ].map((step) => (
